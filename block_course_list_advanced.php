        ...
        if (
            ...
            if ($courses) {
                foreach ($courses as $course) {
                    ...
                    // See at https://docs.moodle.org/dev/NEWMODULE_Adding_capabilities.
                    ...
                    $isnoneditingteacher = !is_enrolled($coursecontext,
                                $USER, 'moodle/course:changecategory', $onlyactive = false)
