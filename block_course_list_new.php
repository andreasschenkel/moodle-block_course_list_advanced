...
class block_course_list_new extends block_list {
    function init() {
    ...
    function get_content() {
        ...
        $adminseesall = true;
        if (isset($CFG->block_course_list_new_adminview)) {
           if ( $CFG->block_course_list_new_adminview == 'own'){
               $adminseesall = false;
           }
        }
    ...
    public function get_config_for_external() {
        ...
        $configs = (object) [
            'adminview' => $CFG->block_course_list_new_adminview,
            'hideallcourseslink' => $CFG->block_course_list_new_hideallcourseslink
        ];
