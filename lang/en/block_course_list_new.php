...
$string['course_list_new:addinstance'] = 'Add a new courses block - new';
$string['course_list_new:myaddinstance'] = 'Add a new courses block to Dashboard - new';
$string['hideallcourseslink'] = 'Hide \'All courses\' link';
$string['owncourses'] = 'Admin user sees own courses - new';
$string['pluginname'] = 'Courses new';
